...
func (fake *FrontmatterSetOperation) ExecuteCallCount() int {
...
func (fake *FrontmatterSetOperation) ExecuteReturnsOnCall(i int, result1 error) {
	fake.executeMutex.Lock()
	defer fake.executeMutex.Unlock()
	fake.ExecuteStub = nil
...
func (fake *FrontmatterSetOperation) Invocations() map[string][][]interface{} {
...
func (fake *FrontmatterSetOperation) recordInvocation(key string, args []interface{}) {
...
var _ ops.FrontmatterSetOperation = new(FrontmatterSetOperation)
